...
const links = [
  { label: 'Home', to: '/' },
  { label: 'Showroom', to: '/products' },
  { label: 'Experiences', to: '/products?tag=luxury' },
  { label: 'Concierge', to: '/checkout' },
];
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-30 bg-white/80 backdrop-blur-xl border-b border-white/40">
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
        <Link to="/" className="font-display text-2xl tracking-wide text-midnight">
        ...
        <div className="flex items-center gap-4">
          <form onSubmit={handleSubmit} className="hidden items-center rounded-full border border-slate-200 px-3 py-1.5 md:flex">
